package com.example.stopatchwithadvertising;
        ...
        private void loadAd(Context context) {
            ...
            AppOpenAd.load(context, AD_ID, request, new AppOpenAd.AppOpenAdLoadCallback() {
                ...
                public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                    ...
                    isLoadingAd = false;
                    Toast.makeText(context, "Có lỗi xảy ra khi tải quảng cáo", Toast.LENGTH_SHORT).show();
                }
                ...
                public void onAdLoaded(@NonNull AppOpenAd openAd) {
                    ...
                    appOpenAd = openAd;
                    isLoadingAd = false;
                    Toast.makeText(context, "Quảng cáo đã được tải", Toast.LENGTH_SHORT).show();
                }
            });
        }
